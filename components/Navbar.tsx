  ...
  return (
    <header className="absolute w-full top-0 z-50 bg-transparent">
      <nav className="w-full mx-auto px-6 md:px-12 lg:px-24 xl:px-28 py-4 flex justify-between items-center">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" d="M3.5 5a1 1 0 0 0 0 2h17a1 1 0 1 0 0-2zm-1 7a1 1 0 0 1 1-1h17a1 1 0 1 1 0 2h-17a1 1 0 0 1-1-1m0 6.001a1 1 0 0 1 1-1h17a1 1 0 1 1 0 2h-17a1 1 0 0 1-1-1" clipRule="evenodd"/></svg>
        </button>
      </nav>
